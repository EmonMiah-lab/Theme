...
function ali_customizar_register($wp_customize){
  ...
  $wp_customize->add_section('ali_header_area', array(
    'title' =>__('Header Area', 'twentyseven'),
  ...
  $wp_customize->add_section('ali_menu_option', array(
    'title' => __('Menu Position Option', 'twentyseven'),
  ...
  $wp_customize->add_section('ali_footer_option', array(
    'title' => __('Footer Option', 'twentyseven'),
  ...
  //logo-width-function
  $wp_customize->add_section('emon-logo',array(
    'title' =>__('Logo width change', 'twentyseven'),
    'description' => 'If you interested to change or update your logo width you can do it.',
  ));
  $wp_customize ->add_setting('emon_logo_size', array(
    'default' => '150px;',
  ));
  $wp_customize->add_control( new WP_Customize_control($wp_customize, 'emon_logo_size', array(
    'label' => 'Logo Width',
    'section' => 'emon-logo',
    'settings' => 'emon_logo_size',
  )));

  // Theme Color
  $wp_customize-> add_section('ali_colors', array(
    'title' => __('Theme Color', 'twentyseven'),
  ...
  // Theme custom login page
   $wp_customize-> add_section('custom_login', array(
     'title' => __('Custom Login', 'twentyseven'),
...
function ali_theme_color_cus(){
  ...
  <style>
    ...
    :root{ --pink:<?php echo get_theme_mod('ali_primary_color'); ?>}
  </style>
  <?php
}
